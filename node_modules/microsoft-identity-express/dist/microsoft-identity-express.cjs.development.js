...
var ConfigHelper = /*#__PURE__*/function () {
  ...
  ConfigHelper.validateAppSettings = function validateAppSettings(appSettings, appType) {
    ...
    switch (appType) {
      case AppType.WebApp:
        if (msalCommon.StringUtils.isEmpty((_appSettings$authRout = appSettings.authRoutes) == null ? void 0 : _appSettings$authRout.redirect)) {
          throw new Error(ConfigurationErrorMessages.NO_REDIRECT_URI);
        }

        if (msalCommon.StringUtils.isEmpty((_appSettings$authRout2 = appSettings.authRoutes) == null ? void 0 : _appSettings$authRout2.unauthorized)) {
...
var BaseAuthClient = /*#__PURE__*/function () {
  function BaseAuthClient(appSettings, msalConfig) {
    ...
    this.logger = new msalCommon.Logger((_this$msalConfig$syst = this.msalConfig.system) == null ? void 0 : _this$msalConfig$syst.loggerOptions, packageName, packageVersion);
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 10:
                ...
                if (!(!tokenResponse || msalCommon.StringUtils.isEmpty(tokenResponse.accessToken))) {
                  _context3.next = 13;
                  break;
                }
    ...
    appRouter.use(function (req, res, next) {
      ...
      if (!req.session.isAuthenticated) {
        ...
        if (rawIdToken) {
          ...
          // parse the id token
          var idTokenClaims = msalCommon.AuthToken.extractTokenClaims(rawIdToken, _this2.cryptoProvider);
          req.session.isAuthenticated = true;
          req.session.account = {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 3:
                ...
                accessTokenClaims = msalCommon.AuthToken.extractTokenClaims(rawAccessToken, _this3.cryptoProvider); // get the name of the resource associated with scope
